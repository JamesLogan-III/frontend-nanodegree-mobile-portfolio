...
var resizePizzas = function(size) {
  ...
  // rewritten to use % widths and DomNodeArray
...
// last top position
var lastTop = 0;
// last Pizza Size 2 = medium
var lastPizzaSize = "2";
// currentlyAnimating flag
...
function updatePositions() {
  ...
  // changed to getElementsByClassName from querySelectorAll for performance reasons
  var items = getDomNodeArray(".mover");
  var lastTop = document.body.scrollTop / 1250;
  var phase;

  // calculate and apply updated positions
  ...
  //turn off request animation flag
  currentlyAnimating = false;

}

//from instructor notes for an array
...
function requestAnimation(updateBackgroundPizzas) {
  ...
  if(!currentlyAnimating) {
    // check if the change is for background or pizza sizes
